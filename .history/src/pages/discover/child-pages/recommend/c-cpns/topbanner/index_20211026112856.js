import React, { memo, useState,useEffect, shallowEqual,useRef } from "react";
...
//   console.log(topBanner);
  ...
  return (
    ...
    <BannerWrapper bgImage1={topBanner[currentIndex].imageUrl+"?imageView&blur=40x20"}>
        {/* bgImage={topBanner[currentIndex]} */}
        {console.log(topBanner[currentIndex].imageUrl+"?imageView&blur=40x20")}

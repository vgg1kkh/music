...
function recommendReducer(state=initialState,action){
    ...
    switch(action.type){
        ...
        case CHANGE_HOT_RECOMMEND:
            console.log("CHANGE_HOT_RECOMMEND Reducer is executed.",action.type)
            return(
                state.set("hotRecommend",action.payload,action.payload)
            )
        case CHANGE_NEW_ALBUM:
            console.log("CHANGE_NEW_ALBUM Reducer is executed.",action.payload)
            return( 

...
export default memo(function TopRanking(props) {
 ...
 const playMusic = (e,item) => {
   e.preventDefault()
   dispatch(createSongDetailsAction(item.id))
 }
  ...
  return (
    <TopRankingWrapper>
      <div className="ranking-header">
        <div className="image">
          <img src={getImageSize(info.coverImgUrl, 80,80)} alt=""></img>
          {console.log("Myurl=",info.coverImgUrl,getImageSize(info.coverImgUrl, 80,80))}
